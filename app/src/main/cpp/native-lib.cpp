...
Java_com_lyd_ffvide1_XPlay_Open(JNIEnv *env, jobject instance, jstring url_, jobject surface) {
...
Java_com_lyd_ffvide1_MainActivity_stringFromJNI(JNIEnv *env, jobject instance) {
